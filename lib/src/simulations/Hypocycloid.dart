...
GlobalKey<_NormalHypoCycloidState> globalKey =
    GlobalKey<_NormalHypoCycloidState>();

List<Offset> ys = [];

class NormalHypoCycloidCurve extends StatefulWidget {
  @override
  _NormalHypoCycloidCurveState createState() => _NormalHypoCycloidCurveState();
}

class _NormalHypoCycloidCurveState extends State<NormalHypoCycloidCurve> {
  double time = 0;
  int innerRadius = 50;
  int outerRadius = 50;
  double f = 0.01;
...
class NormalHypoCycloid extends StatefulWidget {
  NormalHypoCycloid({
  ...
  @override
  _NormalHypoCycloidState createState() => _NormalHypoCycloidState();
}

class _NormalHypoCycloidState extends State<NormalHypoCycloid> {
  List<Offset> points = [];
    ...
    return Container(
      child: Transform.scale(
        scale: widget.isLandscape
            ...
            : widget._scaleAmount,
        child: CustomPaint(
          painter: NormalHypoCycloidPainter(
            widget.outerRadius,
            widget.innerRadius,
            time,
            (widget.isLandscape
...
class NormalHypoCycloidPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(NormalHypoCycloidPainter oldDelegate) => true;

  @override
  bool shouldRebuildSemantics(NormalHypoCycloidPainter oldDelegate) => false;
}
